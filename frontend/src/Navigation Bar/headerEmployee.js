        ...
        <div className="container-fluid " >
            <ul className="navbar-nav ms-5 mt-2">
              <li className="nav-item">
                <Link className="btn btn-light btn-outline-primary" to="/companyInfo">Company Information</Link>
               </li>
                
               <li className="nav-item">
               <Link className="btn btn-light btn-outline-primary" to="/employeesInfo">Employees Information </Link>
              </li>
               
               <li className="nav-item">
                <Link className="btn btn-light btn-outline-primary" to="/editEmployeeProfile">Edit Profile</Link>
               </li>
            </ul>
          </div>
      </nav>
